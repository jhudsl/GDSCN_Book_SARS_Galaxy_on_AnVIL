...
### Importing Data into Galaxy {#importing-data-into-galaxy}
...
## Exercise One: Examining `fastq` Files in Galaxy {#exercise-one-examining-fastq-files-in-galaxy}
...
ottrpal::include_slide("https://docs.google.com/presentation/d/182AOzMaiyrreinnsRX2VhH7YsVgvAp4xtIB_7Mzmk6I/edit#slide=id.gf243efded1_0_12")
```
...
## Exercise Three: Viewing aligned data {#exercise-three-viewing-aligned-data}
